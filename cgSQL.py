...
class sqlCode(Enum):
    ...
    createIndexFile                    = -151
    createClass                        = -155
    createClassesForLevel              = -1
    createClassNone                    = -2
    createInstancesForClass            = -3
    createLevel                        = -414
    ...
    pEventDataReal                     = -382
    pEventDataRealExists               = -482
    pEventDataTime                     = -383
    pEventDataTimeExists               = -483
#    pSFCListIN                         = -356
#    pSFCListIN_OUT                     = -357
#    pSFCListOUT                        = -358
    pSFC                               = -359
...
#                                         ), # gClass
    ...
    sqlCode.pChildOUT                  : ('SELECT S.Class, '
                                                 'S.State, '
                                                 'S.childAlias, '
                                                 'S.childClass, '
                                                 'printf("%d", S.childIndex) AS childIndex, '
